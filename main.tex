...
% ---
\titulo{HAND.IO: UMA LUVA PARA CONTROLE DE DISPOSITOVOS ELETRO-ELETRÔNICOS UTILIZANDO RECONHECIMENTO DE GESTOS}
...
\begin{resumo}[Resumo]
A crescente adoção da internet das coisas, criou novos paradigmas de interação entre usuário e sistemas. Interações mais naturais e personalizadas como comando por voz e por gestos parecem ser mais viáveis do que apenas a utilização de telas touch. A Hand.io é um sistema vestível de reconhecimento de gestos que utiliza algoritmos de aprendizado de máquina para classificar sinais enviados pelo usuário de maneira mais natural possível com o mínimo de dificuldade por parte do usuário.
