...
O desenvolvimento\todo{Falta conectar este texto ao anterior} de tal sistema integrado à vestimenta do usuário funcionará de forma ubíqua e pervasiva, o que permitirá uma melhor interação com ambientes inteligentes, que em um curto período de tempo se tornarão padrão nas áreas residenciais e ambientes de convívio público. Segundo \citeonline{Weiser:1999} as redes ubíquas já são capazes de realizar certas operações em um contexto onde diversos dispositivos inteligentes estão em constante comunicação.  
\todo{adicionar sobre cidades inteligentes, internet das coisas computação pervasiva e ubíqua}
