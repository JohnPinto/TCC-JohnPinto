...
\begin{figure}[ht]
    ...
    \centering
    \legend{Fonte: Adaptado de~\citeonline{BUTTAZZO:2011}.}
    \label{fig:rt}
\end{figure}
...
\begin{figure}[ht]
    ...
    \legend{Fonte: \citeonline{raspberry:pi3}.}
    \label{fig:raspberry}
\end{figure}
...
%Por se tratar de uma linguagem formal, a UML permite a utilização de ferramentas de engenharia de sistemas auxiliada por computador (CASE, em inglês) que geram código executável a partir dos diagramas de modelagem do sistema. 
...
\begin{figure}[ht]
    ...
    \legend{Fonte: Adaptado de~\citeonline{hopcroft:2001}.}
    \label{fig:snack}
\end{figure}
...
\begin{figure}[ht]
    ...
    \legend{Fonte: \citeonline{scikit-learn}.}
    \label{fig:knn}
\end{figure}
