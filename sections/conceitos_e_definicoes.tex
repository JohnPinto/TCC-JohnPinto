...
Microprocessadores são conhecidos como unidades centrais de processamento (CPU, em inglês), e sua função principal é buscar e modificar extensivamente dados da memória, para que sejam armazenados ou exibidos para o usuário.
